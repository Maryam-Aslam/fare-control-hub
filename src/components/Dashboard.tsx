        ...
        <CardContent>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <button className="p-4 border border-gray-200 rounded-lg hover:border-red-300 hover:bg-red-50 transition-colors text-left">
              ...
              <h3 className="font-semibold text-gray-900">New City</h3>
              <p className="text-sm text-gray-600">Add service area</p>
            </button>
            <button className="p-4 border border-gray-200 rounded-lg hover:border-red-300 hover:bg-red-50 transition-colors text-left">
              <DollarSign className="w-8 h-8 text-red-600 mb-2" />
              <h3 className="font-semibold text-gray-900">Manual Booking</h3>
              <p className="text-sm text-gray-600">Create ride booking</p>
            </button>
            <button className="p-4 border border-gray-200 rounded-lg hover:border-red-300 hover:bg-red-50 transition-colors text-left">
              <Bell className="w-8 h-8 text-red-600 mb-2" />
              <h3 className="font-semibold text-gray-900">Send Alert</h3>
              <p className="text-sm text-gray-600">Notify users/drivers</p>
            </button>
          </div>
        </CardContent>
      </Card>
